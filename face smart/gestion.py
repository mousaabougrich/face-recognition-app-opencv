...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.ui.pushButton.clicked.connect(self.run_face_recognition)  # ADD
        self.ui.pushButton_2.clicked.connect(self.run_deletion)         # DELETE
        self.ui.pushButton_3.clicked.connect(self.run_display)          # AFFICHER
        self.ui.pushButton_4.clicked.connect(self.run_edit)             # EDIT
        self.ui.pushButton_5.clicked.connect(self.logout)               # LOGOUT
    ...
    def run_deletion(self):
        # Runs the supp.py script
        subprocess.Popen(['python', 'supp.py'], shell=False)

    def run_display(self):
        # Runs the afficher.py script
        subprocess.Popen(['python', 'afficher.py'], shell=False)

    def run_edit(self):
        # Runs the edit.py script
        subprocess.Popen(['python', 'edit.py'], shell=False)

    def logout(self):
        # Return to the login page facesm.py
        self.close()  # Close the current window
        subprocess.Popen(['python', 'facesm.py'], shell=False)  # Open the login window
